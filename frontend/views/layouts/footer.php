        ...
        <div class="row">
            <div class="col-12 col-lg-6  mt-5 mt-lg-0">
                <div class="partners-form" action="">
                    ...
                    <p class="partners-form-text"><?=$settings->footer_banner?></p>
                </div>
            </div>
        ...
        <div class="footer">
            <div class="f-nav">
                <div class="logo">
                    ...
                    <p class="f-text"><?=$settings->footer_slag?></p>
                </div>
                <ul>
                    <li>
                ...
                <ul class="f-nav__contacts">
                    ...
                    <li>
                        <p class="f-nav__text"><img class="f-img" src="/img/icon/phone-icon.svg" alt=""><a href="+tel:<?=$settings->getMainPhone()?>"><?=$settings->getMainPhone()?></a></p>
                    </li>
                    <li>
